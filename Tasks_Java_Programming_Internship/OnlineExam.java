...
{  
    ...
    {     
        ...
        b1 = new JButton("   Submit Credentials   ");  
...
{  
    ...
    {  
        ...
        if(current==0)  
        {  
            l.setText("Question 1: Which keyword in java is used for exception handling??");  
            jb[0].setText("exep");jb[1].setText("excepHand");jb[2].setText("throw");jb[3].setText("All of these");   
        }  
        if(current==1)  
        {  
            l.setText("Question 2: Which of these cannot be used for a variable name in Java?");  
            jb[0].setText("identifier & keyword");jb[1].setText("identifier");jb[2].setText("keyword");jb[3].setText("none of the mentioned");  
        }  
        if(current==2)  
        {  
            l.setText("Question 3: Where is system class defined?");  
            jb[0].setText("java.lang.package");jb[1].setText("java.util.package ");jb[2].setText("java.lo.package");jb[3].setText("None");  
        }  
        if(current==3)  
        {  
            l.setText("Question 4: Which of the following is a superclass of every class in Java?");  
            jb[0].setText("ArrayList");jb[1].setText("Abstract class");jb[2].setText("Object class");jb[3].setText("String");  
        }  
        if(current==4)  
        {  
            l.setText("Question 5: Which of the following is not an OOPS concept in java?");  
            jb[0].setText("Polymorphism");jb[1].setText("Inheritance");jb[2].setText("Compilation");jb[3].setText("Encapsulation");  
        }  
        if(current==5)  
        {  
            l.setText("Question 6: Identify the infinite loop?");  
            jb[0].setText("for(;;)");jb[1].setText("for()i=0;j<1;i--");jb[2].setText("for(int=0;i++)");jb[3].setText("if(All of the above)");  
        }  
        if(current==6)  
        {  
            l.setText("Question 7: When is the finalize()method called ");  
        ...
        if(current==7)  
        {  
            l.setText("Question 8: Which of these are selection statements in Java?");  
            jb[0].setText("break");jb[1].setText("continue");jb[2].setText("for()");  
                        jb[3].setText("if()");         
        }  
        if(current==8)  
        {  
            l.setText("Question 9: The class at the top of exception class is....?");  
            jb[0].setText("ArithmeticException");jb[1].setText("Throwable");jb[2].setText("Object");jb[3].setText("Console");  
        }  
        if(current==9)  
        {  
            l.setText("Question 10: Which provides runtime enviroment for java byte code to be executed?");  
